...
int main()
{
    ...
    while (!done)//empieza el while del server donde ocurre toda la logica
    {
        ...
        else
        {
            ...
            int offset;//offset de memoria mserver que se esta utilizando
            ...
            else if (type == "char")//revisa se le envio mensaje para creacion de char
            {
